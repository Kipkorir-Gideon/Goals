...
export let Goals: Goal[] = [
    ...
    new Goal(3, 'Get new Phone Case', 'Diana has her birthday coming up soon', new Date(2021,1,)),
    new Goal(4, 'Get Dog Food', 'Pupper likes expensive snacks', new Date(202,11,18)),
